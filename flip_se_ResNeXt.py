...
__all__ = ['ResNeXt', 'resnext50', 'resnext101', 'se_resnext152']
...
class ResNeXt(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, num_group=32):
        self.inplanes = 64
...
def resnext50(num_classes):
    ...
    """
    model = ResNeXt(SEBottleneck, [3, 4, 6, 3], num_classes)
    return model
...
def resnext101(num_classes):
    ...
    """
    model = ResNeXt(SEBottleneck, [3, 4, 23, 3], num_classes)
    return model
...
def se_resnext152(num_classes):
    ...
    """
    model = ResNeXt(SEBottleneck, [3, 8, 36, 3], num_classes)
    return model
